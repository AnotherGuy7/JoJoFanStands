...
{
    public class HolyDiverT3 : FanStandItemClass
    {
        ...
        {
            _waterKatana = GiveItemToSlotOrInventory(player, ModContent.ItemType<WaterKatanaT3>(), null, 0, out _katanaKey);
        ...
        {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<HolyDiverT2>())
