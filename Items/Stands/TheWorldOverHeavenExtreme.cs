...
namespace JoJoFanStands.Items.Stands
{
    public class TheWorldOverHeavenExtreme : FanStandItemClass
    {
        ...
        public override void AddRecipes()
        {
            ...
            if (calamityMod.TryFind<ModItem>("ShadowspecBar", out ModItem shadowspecBar))
