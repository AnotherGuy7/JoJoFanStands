...
namespace JoJoFanStands.Projectiles.PlayerStands
{
    public class SlavesOfFearStandFinal : StandClass
    {
        ...
        public override int punchDamage => 98;          //this is just a test to see whether I really know enough
        ...
        public override void AI()
        {
            ...
            if (player.HeldItem.type == mod.ItemType("SlavesOfFearFinal") && fPlayer.StandOut)
            {
                projectile.timeLeft = 2;
            }
            if (player.HeldItem.type != mod.ItemType("SlavesOfFearFinal") || !fPlayer.StandOut || player.dead)
            {
