...
{
    public class VirtualInsanityStandT2 : StandClass
    {
        ...
        private const float PowerInstallDuration = 50f * 60f;
        ...
        public static readonly SoundStyle PowerInstallThemeExit = new SoundStyle("JoJoStandsSounds/Sounds/SoundEffects/VirtualInsanity/PowerInstallExit_2")
        {
        ...
        public override void AI()
        {
            ...
            if (!throwingProjectile && !powerInstallAnimation && !playerHasAbilityCooldown && SecondSpecialKeyPressed(false))
            {
                ...
                {
                    player.AddBuff(ModContent.BuffType<PowerInstall>(), (int)PowerInstallDuration);      //50s
