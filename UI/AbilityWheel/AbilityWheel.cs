...
namespace JoJoFanStands.UI.AbilityWheel
{
    public class AbilityWheel : UIState
    {
        ...
        {
            abilityWheel = new UIPanel();
            abilityWheel.Left.Set(Main.screenWidth - (AbilityWheelSize.X / 2f), 0f);
            abilityWheel.Top.Set(Main.screenHeight * JoJoStands.UI.AbilityWheel.VerticalAlignmentPercentage, 0f);
            ...
            wheelCenter = new AdjustableButton(ModContent.Request<Texture2D>("JoJoFanStands/UI/AbilityWheel/WheelCenter", AssetRequestMode.ImmediateLoad), Vector2.Zero, AbilityWheelSize, Color.White, 1f, 1f);
            ...
            {
                abilityButtons[i] = new AdjustableButton(ModContent.Request<Texture2D>("JoJoFanStands/UI/AbilityWheel/WheelPiece", AssetRequestMode.ImmediateLoad), wheelCenter.buttonCenter + (IndexToRadianPosition(i, 6) * wheelSpace), new Vector2(38f), Color.White, 1f, 1f);
        ...
        {
            Vector2 placementVector = Vector2.Transform(new Vector2(Main.screenWidth - (AbilityWheelSize.X / 2f), Main.screenHeight * JoJoStands.UI.AbilityWheel.VerticalAlignmentPercentage), Main.UIScaleMatrix);
            ...
            if (JoJoStands.JoJoStands.AbilityWheelDescriptions)
            {
